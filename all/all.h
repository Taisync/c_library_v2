...
#define MAVLINK_ALL_XML_HASH 2902522288232196801
...
{11047, 38, 1, 1, 0, 0, 0}, \
{11048, 214, 1, 1, 0, 0, 0}, \
{11050, 64, 10, 10, 0, 0, 0}, \
{11051, 55, 3, 3, 0, 0, 0}, \
{11052, 219, 10, 10, 0, 0, 0}, \
{11053, 5, 16, 16, 0, 0, 0}, \
...
{60045, 14, 15, 23, 3, 2, 3}, \
{60046, 171, 28, 28, 3, 8, 9}, \
{60047, 55, 7, 7, 0, 0, 0}, \
...
#ifdef TAISYNC_GIMBAL
#include "../s_gimbal/s_gimbal.h"
#endif
...
MAVLINK_MESSAGE_INFO_LINK_NODE_STATUS, \
...
MAVLINK_MESSAGE_INFO_COMMAND_CANCEL, \
...
MAVLINK_MESSAGE_INFO_MEMINFO, \
MAVLINK_MESSAGE_INFO_AP_ADC, \
MAVLINK_MESSAGE_INFO_DIGICAM_CONFIGURE, \
MAVLINK_MESSAGE_INFO_DIGICAM_CONTROL, \
MAVLINK_MESSAGE_INFO_MOUNT_CONFIGURE, \
MAVLINK_MESSAGE_INFO_MOUNT_CONTROL, \
MAVLINK_MESSAGE_INFO_MOUNT_STATUS, \
MAVLINK_MESSAGE_INFO_FENCE_POINT, \
MAVLINK_MESSAGE_INFO_FENCE_FETCH_POINT, \
MAVLINK_MESSAGE_INFO_FENCE_STATUS, \
MAVLINK_MESSAGE_INFO_AHRS, \
MAVLINK_MESSAGE_INFO_SIMSTATE, \
MAVLINK_MESSAGE_INFO_HWSTATUS, \
MAVLINK_MESSAGE_INFO_RADIO, \
MAVLINK_MESSAGE_INFO_LIMITS_STATUS, \
MAVLINK_MESSAGE_INFO_WIND, \
MAVLINK_MESSAGE_INFO_DATA16, \
MAVLINK_MESSAGE_INFO_DATA32, \
MAVLINK_MESSAGE_INFO_DATA64, \
MAVLINK_MESSAGE_INFO_DATA96, \
MAVLINK_MESSAGE_INFO_RANGEFINDER, \
MAVLINK_MESSAGE_INFO_AIRSPEED_AUTOCAL, \
MAVLINK_MESSAGE_INFO_RALLY_POINT, \
MAVLINK_MESSAGE_INFO_RALLY_FETCH_POINT, \
MAVLINK_MESSAGE_INFO_COMPASSMOT_STATUS, \
MAVLINK_MESSAGE_INFO_AHRS2, \
MAVLINK_MESSAGE_INFO_CAMERA_STATUS, \
MAVLINK_MESSAGE_INFO_CAMERA_FEEDBACK, \
MAVLINK_MESSAGE_INFO_BATTERY2, \
MAVLINK_MESSAGE_INFO_AHRS3, \
MAVLINK_MESSAGE_INFO_AUTOPILOT_VERSION_REQUEST, \
MAVLINK_MESSAGE_INFO_REMOTE_LOG_DATA_BLOCK, \
MAVLINK_MESSAGE_INFO_REMOTE_LOG_BLOCK_STATUS, \
MAVLINK_MESSAGE_INFO_LED_CONTROL, \
MAVLINK_MESSAGE_INFO_MAG_CAL_PROGRESS, \
MAVLINK_MESSAGE_INFO_MAG_CAL_REPORT, \
MAVLINK_MESSAGE_INFO_EKF_STATUS_REPORT, \
MAVLINK_MESSAGE_INFO_PID_TUNING, \
MAVLINK_MESSAGE_INFO_DEEPSTALL, \
MAVLINK_MESSAGE_INFO_GIMBAL_REPORT, \
MAVLINK_MESSAGE_INFO_GIMBAL_CONTROL, \
MAVLINK_MESSAGE_INFO_GIMBAL_TORQUE_CMD_REPORT, \
MAVLINK_MESSAGE_INFO_GOPRO_HEARTBEAT, \
MAVLINK_MESSAGE_INFO_GOPRO_GET_REQUEST, \
MAVLINK_MESSAGE_INFO_GOPRO_GET_RESPONSE, \
MAVLINK_MESSAGE_INFO_GOPRO_SET_REQUEST, \
MAVLINK_MESSAGE_INFO_GOPRO_SET_RESPONSE, \
MAVLINK_MESSAGE_INFO_NAV_FILTER_BIAS, \
MAVLINK_MESSAGE_INFO_RADIO_CALIBRATION, \
MAVLINK_MESSAGE_INFO_UALBERTA_SYS_STATUS, \
MAVLINK_MESSAGE_INFO_COMMAND_INT_STAMPED, \
MAVLINK_MESSAGE_INFO_COMMAND_LONG_STAMPED, \
MAVLINK_MESSAGE_INFO_EFI_STATUS, \
MAVLINK_MESSAGE_INFO_RPM, \
MAVLINK_MESSAGE_INFO_ESTIMATOR_STATUS, \
MAVLINK_MESSAGE_INFO_WIND_COV, \
MAVLINK_MESSAGE_INFO_GPS_INPUT, \
MAVLINK_MESSAGE_INFO_GPS_RTCM_DATA, \
MAVLINK_MESSAGE_INFO_HIGH_LATENCY, \
MAVLINK_MESSAGE_INFO_HIGH_LATENCY2, \
...
MAVLINK_MESSAGE_INFO_ADSB_VEHICLE, \
MAVLINK_MESSAGE_INFO_COLLISION, \
...
MAVLINK_MESSAGE_INFO_BUTTON_CHANGE, \
MAVLINK_MESSAGE_INFO_PLAY_TUNE, \
...
MAVLINK_MESSAGE_INFO_RAW_RPM, \
MAVLINK_MESSAGE_INFO_UTM_GLOBAL_POSITION, \
MAVLINK_MESSAGE_INFO_DEBUG_FLOAT_ARRAY, \
MAVLINK_MESSAGE_INFO_SET_VELOCITY_LIMITS, \
MAVLINK_MESSAGE_INFO_VELOCITY_LIMITS, \
...
MAVLINK_MESSAGE_INFO_FUEL_STATUS, \
MAVLINK_MESSAGE_INFO_BATTERY_INFO, \
...
MAVLINK_MESSAGE_INFO_CAN_FRAME, \
...
MAVLINK_MESSAGE_INFO_EVENT, \
MAVLINK_MESSAGE_INFO_CURRENT_EVENT_SEQUENCE, \
MAVLINK_MESSAGE_INFO_REQUEST_EVENT, \
MAVLINK_MESSAGE_INFO_RESPONSE_EVENT_ERROR, \
MAVLINK_MESSAGE_INFO_GROUP_START, \
MAVLINK_MESSAGE_INFO_GROUP_END, \
MAVLINK_MESSAGE_INFO_RADIO_RC_CHANNELS, \
MAVLINK_MESSAGE_INFO_AVAILABLE_MODES, \
MAVLINK_MESSAGE_INFO_CURRENT_MODE, \
MAVLINK_MESSAGE_INFO_AVAILABLE_MODES_MONITOR, \
MAVLINK_MESSAGE_INFO_ILLUMINATOR_STATUS, \
MAVLINK_MESSAGE_INFO_GNSS_INTEGRITY, \
MAVLINK_MESSAGE_INFO_TARGET_ABSOLUTE, \
MAVLINK_MESSAGE_INFO_TARGET_RELATIVE, \
MAVLINK_MESSAGE_INFO_CONTROL_STATUS, \
MAVLINK_MESSAGE_INFO_SENS_POWER, \
MAVLINK_MESSAGE_INFO_SENS_MPPT, \
MAVLINK_MESSAGE_INFO_ASLCTRL_DATA, \
MAVLINK_MESSAGE_INFO_ASLCTRL_DEBUG, \
MAVLINK_MESSAGE_INFO_ASLUAV_STATUS, \
MAVLINK_MESSAGE_INFO_EKF_EXT, \
MAVLINK_MESSAGE_INFO_ASL_OBCTRL, \
MAVLINK_MESSAGE_INFO_SENS_ATMOS, \
MAVLINK_MESSAGE_INFO_SENS_BATMON, \
MAVLINK_MESSAGE_INFO_FW_SOARING_DATA, \
MAVLINK_MESSAGE_INFO_SENSORPOD_STATUS, \
MAVLINK_MESSAGE_INFO_SENS_POWER_BOARD, \
MAVLINK_MESSAGE_INFO_GSM_LINK_STATUS, \
MAVLINK_MESSAGE_INFO_SATCOM_LINK_STATUS, \
MAVLINK_MESSAGE_INFO_SENSOR_AIRFLOW_ANGLES, \
...
MAVLINK_MESSAGE_INFO_UAVIONIX_ADSB_OUT_CFG_FLIGHTID, \
MAVLINK_MESSAGE_INFO_UAVIONIX_ADSB_GET, \
MAVLINK_MESSAGE_INFO_UAVIONIX_ADSB_OUT_CONTROL, \
MAVLINK_MESSAGE_INFO_UAVIONIX_ADSB_OUT_STATUS, \
MAVLINK_MESSAGE_INFO_LOWEHEISER_GOV_EFI, \
MAVLINK_MESSAGE_INFO_DEVICE_OP_READ, \
MAVLINK_MESSAGE_INFO_DEVICE_OP_READ_REPLY, \
MAVLINK_MESSAGE_INFO_DEVICE_OP_WRITE, \
MAVLINK_MESSAGE_INFO_DEVICE_OP_WRITE_REPLY, \
MAVLINK_MESSAGE_INFO_SECURE_COMMAND, \
MAVLINK_MESSAGE_INFO_SECURE_COMMAND_REPLY, \
MAVLINK_MESSAGE_INFO_ADAP_TUNING, \
MAVLINK_MESSAGE_INFO_VISION_POSITION_DELTA, \
MAVLINK_MESSAGE_INFO_AOA_SSA, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_1_TO_4, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_5_TO_8, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_9_TO_12, \
...
MAVLINK_MESSAGE_INFO_OBSTACLE_DISTANCE_3D, \
MAVLINK_MESSAGE_INFO_WATER_DEPTH, \
MAVLINK_MESSAGE_INFO_MCU_STATUS, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_13_TO_16, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_17_TO_20, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_21_TO_24, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_25_TO_28, \
MAVLINK_MESSAGE_INFO_ESC_TELEMETRY_29_TO_32, \
MAVLINK_MESSAGE_INFO_EC_REQUEST, \
MAVLINK_MESSAGE_INFO_EC_VERSION, \
MAVLINK_MESSAGE_INFO_EC_GIMBAL_CONTROL, \
MAVLINK_MESSAGE_INFO_EC_GIMBAL_CALIBRATION, \
MAVLINK_MESSAGE_INFO_EC_GIMBAL_REPORT, \
MAVLINK_MESSAGE_INFO_EC_GIMBAL_CHANNEL_CONFIG, \
...
MAVLINK_MESSAGE_INFO_OPEN_DRONE_ID_ARM_STATUS, \
MAVLINK_MESSAGE_INFO_OPEN_DRONE_ID_SYSTEM_UPDATE, \
MAVLINK_MESSAGE_INFO_HYGROMETER_SENSOR, \
MAVLINK_MESSAGE_INFO_TEST_TYPES, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_0, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_1, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_3, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_4, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_5, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_6, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_7, \
MAVLINK_MESSAGE_INFO_ARRAY_TEST_8, \
MAVLINK_MESSAGE_INFO_ICAROUS_HEARTBEAT, \
MAVLINK_MESSAGE_INFO_ICAROUS_KINEMATIC_BANDS, \
MAVLINK_MESSAGE_INFO_CUBEPILOT_RAW_RC, \
MAVLINK_MESSAGE_INFO_HERELINK_VIDEO_STREAM_INFORMATION, \
MAVLINK_MESSAGE_INFO_HERELINK_TELEM, \
MAVLINK_MESSAGE_INFO_CUBEPILOT_FIRMWARE_UPDATE_START, \
MAVLINK_MESSAGE_INFO_CUBEPILOT_FIRMWARE_UPDATE_RESP, \
MAVLINK_MESSAGE_INFO_AIRLINK_AUTH, \
MAVLINK_MESSAGE_INFO_AIRLINK_AUTH_RESPONSE, \
MAVLINK_MESSAGE_INFO_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT, \
MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_INFORMATION, \
MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_STATUS, \
MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_CONTROL, \
MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_CONTROL_PITCHYAW, \
MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_CORRECT_ROLL, \
MAVLINK_MESSAGE_INFO_QSHOT_STATUS, \
MAVLINK_MESSAGE_INFO_FRSKY_PASSTHROUGH_ARRAY, \
MAVLINK_MESSAGE_INFO_PARAM_VALUE_ARRAY, \
MAVLINK_MESSAGE_INFO_MLRS_RADIO_LINK_STATS, \
MAVLINK_MESSAGE_INFO_MLRS_RADIO_LINK_INFORMATION, \
MAVLINK_MESSAGE_INFO_MLRS_RADIO_LINK_FLOW_CONTROL, \
MAVLINK_MESSAGE_INFO_AVSS_PRS_SYS_STATUS, \
MAVLINK_MESSAGE_INFO_AVSS_DRONE_POSITION, \
MAVLINK_MESSAGE_INFO_AVSS_DRONE_IMU, \
MAVLINK_MESSAGE_INFO_AVSS_DRONE_OPERATION_MODE \
}
...
{ "EC_GIMBAL_CALIBRATION", 11051 }, \
{ "EC_GIMBAL_CHANNEL_CONFIG", 11053 }, \
{ "EC_GIMBAL_CONTROL", 11050 }, \
{ "EC_GIMBAL_REPORT", 11052 }, \
{ "EC_REQUEST", 11047 }, \
{ "EC_VERSION", 11048 }, \
